...
export function showOverlay(displayText) {
	...
	if (!overlayDiv) {
		...
		overlaySubDiv.className = "bg-secondary text-white mx-5 my-5 px-5 py-5 text-center align-items-center";
...
export function createSelectBox(id, labelText, jsFunction) {
